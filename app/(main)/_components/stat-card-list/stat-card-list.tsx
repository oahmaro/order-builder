  ...
  const orderStats = [
    {
      ...
      href: '/orders?page=1&pageSize=10&sortBy=createdAt&sortDir=desc&status=NEW',
    ...
    },
    {
      ...
      href: '/orders?page=1&pageSize=10&sortBy=createdAt&sortDir=desc&status=COMPLETED',
          ...
          <Accordion.Panel>
            <SimpleGrid cols={{ base: 1, xs: 2 }}>
              <StatCard
                ...
                href="/customers?page=1&pageSize=10&sortBy=createdAt&sortDir=desc"
              ...
              <StatCard
                ...
                href="/orders?page=1&pageSize=10&sortBy=createdAt&sortDir=desc"
